          ...
          {products.map((p, idx) => (
            ...
            >
              <div className="relative aspect-square bg-slate-50 overflow-hidden">
                ...
                />
                <button className="absolute bottom-4 right-4 w-12 h-12 rounded-full bg-white shadow-xl flex items-center justify-center text-slate-900 hover:bg-carvantooo-500 hover:text-white transition-all transform translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100">
