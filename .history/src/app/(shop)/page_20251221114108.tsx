...
import { ShoppingCart, Truck, ShieldCheck, Star, ShoppingBag, ChevronRight, Package, LayoutGrid, List } from 'lucide-react';
          ...
          {isLoading ? (
            ...
            products.map((p) => (
              <ProductCard
                ...
                rating={4.5} // Mock-Rating da nicht im Schema
                reviews={10} // Mock-Reviews da nicht im Schema
              />
            ))
          ) : (
            <div className="col-span-full py-20 text-center text-slate-500">
