...
// import { cn } from '../../lib/utils'; // Not strictly needed if not used, but good practice

export const Hero = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center bg-mesh-red overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-20">
        ...
        >
          <span className="text-carvantooo-500 bg-clip-text text-transparent bg-gradient-carvantooo">OpenCarBox</span>
          <br className="sm:hidden" />
          <span className="text-slate-400 mx-4 hidden sm:inline">&</span>
          <br className="sm:hidden" />
          <span className="text-opencarbox-500 bg-clip-text text-transparent bg-gradient-opencarbox">Carvantooo</span>
        </motion.h1>
        ...
        <motion.div
          ...
          className="bg-white/60 backdrop-blur-md max-w-3xl mx-auto p-2 sm:p-3 mb-12 shadow-2xl relative group rounded-2xl border border-white/20"
        >
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 sm:p-8 flex flex-col gap-6 relative">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button className="h-14 px-10 rounded-xl bg-carvantooo-500 hover:bg-carvantooo-600 text-white text-lg font-bold shadow-lg shadow-carvantooo-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
                Teile finden
