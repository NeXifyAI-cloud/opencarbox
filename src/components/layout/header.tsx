...
export function Header({ cartItems = 0 }: HeaderProps) {
  ...
  return (
    <header className="w-full shadow-sm sticky top-0 z-50">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between gap-8">
            ...
            <Link href="/" className="flex items-center gap-4 flex-shrink-0 group">
              ...
              <div>
                <span className="text-3xl font-bold tracking-tight text-white group-hover:text-[#4fd1c5] transition-colors">Carvantooo</span>
      ...
      <div className="bg-[#f8fafc] border-b border-gray-200 py-4">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-4 flex-wrap">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all ${
                      selectedVehicleType === type.id
                        ...
                        : 'bg-white text-[#1e3a5f] border border-gray-200 hover:border-[#4fd1c5]'
                    }`}
                  >
            ...
            <Button className="bg-[#4fd1c5] hover:bg-[#38b2ac] text-[#1e3a5f] font-semibold">
              Teile finden
            </Button>
          </div>
        </div>
